...
The Contributors Sandbox folder is a place to learn and experiment, so free to add and update pages there. You can access the folder by clicking on the Browse button in the upper left corner.

The folder is visible only to users in the Contributors group, which is currently everyone with login priveleges (i.e. everyone except Guests).
